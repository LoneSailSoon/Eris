...
{
    private const nint ArrayPointer = 0xA83CE0;

    public static readonly GlobalDvcArray<UnitTypeClass> AbstractTypeArray = new(ArrayPointer);
    ...
    [FieldOffset(3580)] public LandType MovementRestrictedTo;
    [FieldOffset(3584)] public CoordStruct HalfDamageSmokeLocation;
    ...
    [FieldOffset(3672)] public nint altImage;
    public Pointer<ShpStruct> AltImage => altImage;
    [FieldOffset(3676)] public byte WalkFrames;
    [FieldOffset(3677)] public byte FiringFrames;
    [FieldOffset(3678)] public byte altImageFile;
    public FixedArray<byte> AltImageFile => new(ref Unsafe.As<byte, byte>(ref altImageFile), 25);
