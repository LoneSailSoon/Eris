...
public static class CircleDifferentiator
{
    ...
    /// <returns></returns>
    public static List<CoordStruct> DivideArcByTolerance(CoordStruct center, int radius, int tolerance = 128,
    ...
    /// <param name="upVector">(0,0,0) is equal to (0,0,1)</param>
    /// <returns></returns>
    public static List<CoordStruct> DivideArcByCount(CoordStruct center, int radius, int pointCount,
        Vector3 upVector = default)
    {
