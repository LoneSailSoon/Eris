...
public struct SuperClass : IYrObject<SuperWeaponTypeClass>
{
    Pointer<SuperWeaponTypeClass> IYrObject<SuperWeaponTypeClass>.Type => Type;
    ...
    public Pointer<AnimClass> Animation
    {
        get => animation;
        set => animation = value;
    }
