...
public struct AnimTypeClass
{
    ...
    public static GlobalDvcArray<AnimTypeClass> AbstractTypeArray { get; } = new GlobalDvcArray<AnimTypeClass>(ArrayPointer);
    ...
    [FieldOffset(712)] public nint next;
    ...
    [FieldOffset(752)] public nint spawns;
