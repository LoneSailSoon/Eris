...
namespace PatcherYrSharp;
    ...
    public struct HouseTypeClass
	{
		...
		public static GlobalDvcArray<HouseTypeClass> AbstractTypeArray = new GlobalDvcArray<HouseTypeClass>(ArrayPointer);



		public Pointer<HouseTypeClass> FindParentCountry()
		{
			return AbstractTypeArray.Find(ParentCountry);
		}
