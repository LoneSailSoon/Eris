...
public abstract class TechnoScriptable : Scriptable<TechnoEntity>
{
    [Sync]
    ...
    public static void OnPut(Generic.Component component, in (Pointer<CoordStruct> pCoord, Direction dir) data)
    {
        (component as TechnoScriptable)?.OnPut(data.pCoord, data.dir);
    }
    public static void OnReceiveDamage(Generic.Component component, in (Pointer<int> pDamage, int distanceFromEpicenter, Pointer<WarheadTypeClass> pWh,
        Pointer<ObjectClass> pAttacker, bool ignoreDefenses, bool preventPassengerEscape,
    ...
    public static void OnFire(Generic.Component component, in (int weaponIndex, Pointer<AbstractClass> target) data)
    {
