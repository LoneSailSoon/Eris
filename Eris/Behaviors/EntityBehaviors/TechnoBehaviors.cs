...
public static class TechnoBehaviors
{
    ...
    public static unsafe uint TechnoClass_Update_Behaviors(Registers* r)
    {
        try
        {
            ...
            var entity = TechnoEntity.EntityMap.Find(pTechno);

            entity?.GameObject.ForEach(o => o.OnUpdate());
        }
        catch (Exception e)
        {
    ...
    public static unsafe uint TechnoClass_Put_Behaviors(Registers* r)
    {
        try
        {
            ...
            entity?.GameObject.ForEach((pCoord, faceDir), TechnoScriptable.OnPut);
    ...
    public static unsafe uint TechnoClass_Remove_Behaviors(Registers* r)
    {
        try
        {
            ...
            entity?.GameObject.ForEach(o => (o as TechnoScriptable)?.OnRemove());
    ...
    public static unsafe uint TechnoClass_ReceiveDamage_Behaviors(Registers* r)
    {
        try
        {
            ...
            entity?.GameObject.ForEach((pDamage, distanceFromEpicenter, pWH: pWh, pAttacker, ignoreDefenses, preventPassengerEscape, pAttackingHouse), TechnoScriptable.OnReceiveDamage);
    ...
    public static unsafe uint TechnoClass_Fire_Behaviors(Registers* r)
    {
        try
        {
            ...
            {
                entity.GameObject.ForEach((nWeaponIndex, pTarget), TechnoScriptable.OnFire);
            }
