...
namespace Eris.Extension.Core.Generic;
...
public sealed class GameObject : INaegleriaSerializable
{
    ...
    public ReadOnlySpan<Component> GetLatestBuffer()
    {
        return _expired ? ReadOnlySpan<Component>.Empty :
            _state == State.Right ? _rightBuffer.AsSpan(0, _rightBufferSize) : _leftBuffer.AsSpan(0, _leftBufferSize);
    }
