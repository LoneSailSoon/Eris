...
public abstract class StyleStateModule : StyleModule
{
    ...
    public virtual void ToTreeDisplay(StringBuilder sb, string linePrefix)
    {
        
    }

    public static void ToTreeDisplay(StyleStateModule? styleStateModule, StringBuilder sb, string linePrefix)
    {
        if (styleStateModule is null)
            sb.AppendTreeLeafLast(linePrefix, "null");
        else
            styleStateModule.ToTreeDisplay(sb, linePrefix);
    }
}
